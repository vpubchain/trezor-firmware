...
if TYPE_CHECKING:  # pragma: no cover
    from ..bin_size.api import DataRow, BinarySizeAPI
...
class StatisticsPlugin:
    ...
    def show_data_with_categories(
        ...
        self._show(final_output, file_to_save)
    ...
    def _get_printable_output(
        ...
        if not include_none:
            ...
            statistics_data = [
                row for row in statistics_data if row.category is not None
            ]
        summary = self._get_data_summary(statistics_data)
