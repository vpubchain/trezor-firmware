...
from ..src.bin_size.row_handler_c import CRow
...
def test_clean_special_symbols(symbol: str, symbol_after: str):
    assert CR._clean_special_symbols(symbol) == symbol_after
...
def test_validate_line_for_definition_true(line_with_SYMBOL: str):
    assert CR._validate_line_for_definition(line_with_SYMBOL, "SYMBOL") is True
...
def test_validate_line_for_definition_accept_declaration(line_with_SYMBOL: str):
    assert (
        CR._validate_line_for_definition(
...
def test_validate_line_for_definition_special_true(symbol: str, line: str):
    assert CR._validate_line_for_definition(line, symbol) is True
...
def test_validate_line_for_definition_false(line_with_SYMBOL: str):
    assert CR._validate_line_for_definition(line_with_SYMBOL, "SYMBOL") is False
