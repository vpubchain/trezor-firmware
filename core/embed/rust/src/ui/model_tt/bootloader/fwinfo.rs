...
use crate::ui::model_tt::bootloader::theme::{BLD_BG, BLD_FG, BLD_TITLE_COLOR, button_bld_menu_item};
...
impl FwInfo
{
    pub fn new(fingerprint: &'static str,
    ) -> Self {
...
impl Component for FwInfo
{
    ...
    fn place(&mut self, bounds: Rect) -> Rect {
        ...
        self.exit.place(Rect::new (Point::new(16,178), Point::new( 16+209,178+48)));

        bounds
    }

    fn event(&mut self, ctx: &mut EventCtx, event: Event) -> Option<Self::Msg> {
        if let Some(Clicked) = self.exit.event(ctx, event) { return Some(Self::Msg::Exit)};
        None
    }
    ...
    fn paint(&mut self) {
        ...
        display::rect_fill(Rect::new (Point::new(16,44), Point::new(WIDTH-12, 45)), BLD_FG);
        display::text_top_left(Point::new(15,24), self.message, FONT_BOLD, BLD_TITLE_COLOR, BLD_BG);
